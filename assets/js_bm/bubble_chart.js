...
/* ------------------------------------------------------------------*/
  ...
  var abandonTitleX = { // X locations of the year titles.
    'Für wie viel Geld mindestens würden sie all ihre Geräte eine Woche gar nicht benutzen?': 500, 
    '"Würde ich auch gratis machen"': 170,
    '"Für 5 - 50 Franken"': 350,
    '"Für 100 Franken"': 550,
    '"Für mehr als 100 Franken"': 780
  };  
    
     var abandonTitleY = {  // Y locations of the year titles.
    'Für wie viel Geld mindestens würden sie all ihre Geräte eine Woche gar nicht benutzen?': 35, 
    '"Würde ich auch gratis machen"': 70,
    '"Für 5 - 50 Franken"': 70, 
    '"Für 100 Franken"': 70, 
    '"Für mehr als 100 Franken"': 70
  };  
...
function moveToAbandon(alpha) {
  ...
  function showAbandon() {
    ...
    abandon.enter().append('text')
      ...
      .attr('y', function (d) { return abandonTitleY[d]; })
      .attr('text-anchor', 'middle')
      .text(function (d) { return d; });
    }
...
// -----------------------------------------------------------------*/    
  ...
  function showDetail(d) {
    ...
    var content = '<span class="name">Alter: </span><span class="value">' +
                  ...
                  d.desktext +
                  '</span>';
                  '<span class="name">"Für wieviel Geld würden Sie Ihre Geräte eine Woche nicht benutzen?": </span><span class="value">' +
                  d.abandon +
                  '</span>';
